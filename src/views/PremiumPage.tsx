...
const PremiumPage: React.FC = () => {
  ...
  const handleRunCodeRequest = (code: string, language: string) => {
    ...
    if (slug) {
      ...
      const url = `https://onecompiler.com/embed/${slug}?code=${encodedCode}&theme=dark_plus&listenToEvents=true&hideNew=true`;
      setOneCompilerUrl(url);
      ...
      setAlertInfo({ id: Date.now(), type: 'info', message: `Running ${language} code is not supported with OneCompiler integration.`});
    }
  };
