...
import UIDesignerPage from './views/UIDesignerPage'; // Import the new page
import ImageEnhancerPage from './views/ImageEnhancerPage'; // New Page
          ...
          <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
            ...
            <main className="flex-grow">
              <Routes>
                ...
                <Route path="/image-enhancer" element={<ImageEnhancerPage />} /> {/* New Route */}
                <Route 
                  path="/premium" 
                  element={
                    <ProtectedRoute>
